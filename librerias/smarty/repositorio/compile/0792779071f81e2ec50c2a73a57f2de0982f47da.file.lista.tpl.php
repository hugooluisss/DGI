<?php /* Smarty version Smarty-3.1.11, created on 2015-09-01 10:29:24
...
?>
					<tr>
						...
						<td><?php echo $_smarty_tpl->tpl_vars['row']->value->getNombreCompleto();?>
</td>
...
"><?php echo $_smarty_tpl->tpl_vars['tipo']->value['descripcion'];?>
						...
						<td style="text-align: right">
							<button type="button" class="btn btn-danger btn-circle" action="eliminar" title="Eliminar" trabajador="<?php echo $_smarty_tpl->tpl_vars['row']->value->getId();?>
