...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>.: IEBO :: DGI :.</title>
		<meta name="generator" content="Bootply" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
		<link href="{$PAGE.ruta}css/bootstrap.min.css" rel="stylesheet">
		<!--[if lt IE 9]>
			<script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
		<![endif]-->
		<link href="{$PAGE.ruta}css/styles.css" rel="stylesheet">
	</head>
	<body>
<!-- Header -->
<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
	...
	<a class="navbar-brand" href="#">{$PAGE.nombreAplicacion}</a>
	</div>
...
<div class="modal" id="addWidgetModal">
  <div class="modal-dialog">
	...
	<!-- script references -->
		...
		<script src="{$PAGE.ruta}/js/bootstrap.min.js"></script>
	</body>
</html>